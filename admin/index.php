            ...
            <!-- /widget-header -->
                      <div class="widget-content">
                        <div class="widget big-stats-container">
                            <h4>Selamat Datang di <b>Aplikasi Reservasi Lapangan Futsal <?php echo "$namaprofil";?></b> !<br />
                          <div class="right"> <img src="img/logo.png" alt="centerleft" width="38%"/></div>
                        </div>
                            Alamat : <?php echo "$alamatprofil";?>, Kode Pos : <?php echo "$kodeposprofil";?> Telepon: <?php echo "$no_telponprofil";?>, Fax : <?php echo "$faxprofil";?></h4>
