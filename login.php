...
$perintah_query=mysql_query("SELECT * FROM pelanggan WHERE username= '$_POST[username]' AND password='$_POST[password]'");
...
<body style="background-image:url(Gambar/futsal.jpg);background-size:cover;">
...
<div class="account-container">
	...
	<div class="content clearfix">
		...
		<form action="" method="post">
			<img src="Gambar/logo.png" width="40%" alt="" srcset="">
			...
			<?php } ?>
			<a href="admin/login.php">			Login Administrator	</a>||  <a href="index.php">Back</a> 
			<div class="login-fields">
				
				<p>Belum punya akun silahkan hubungi pemilik lapang futsal</p>
