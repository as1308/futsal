...
<head>
<meta charset="utf-8">
<title>Lapangan Poin Futsal</title>
<!-- CK EDITOR -->
...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container">
	<a class="brand" href="index.php"> POIN FUTSAL</a>
...
?>
              ...
              <a href="admin/modul/daftar_member.php"></a>
              <a href="https://wa.me/6282213874446"><img src="Gambar/cara-membuat-chat-otomatis-di-whatsapp.png" width="451" height="194" border="0"></a>
              <div class="col-md-9" >
                ...
                <div class="widget">
                  ...
                  <div class="widget-content">
                      ...
                      <h4 class="text-center">SELAMAT DATANG  <?php echo $_SESSION['namapengunjung']?></h4>
<center><video controls>
  <source src="futsal.mp4" type="video/mp4" width="960" height="720"></center>
</video>
                     </div> 
                  <!-- /widget-content -->
          </div> <!-- /widget -->
